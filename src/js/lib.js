...
Object.assign(Ci.prototype, {
  ...
  setStyle: function(e) {
      ...
      e && e.length > 0 && (void 0 !== (c = Pi[e]) ? this.setHex(c) : console.warn("THREE.Color: Unknown color " + e));
      return this
  },
  clone: function() {
  ...
  getHSL: function(e) {
      var t, i, n = e || {
          ...
          s: 0,
          l: 0
      }, r = this.r, o = this.g, s = this.b, a = Math.max(r, o, s), l = Math.min(r, o, s), c = (l + a) / 2;
      if (l === a)
          t = 0,
          i = 0;
      else {
          var u = a - l;
          switch (i = c <= .5 ? u / (a + l) : u / (2 - a - l),
          a) {
          case r:
              t = (o - s) / u + (o < s ? 6 : 0);
              break;
...
const Ri = {
  ...
  points: {
    uniforms: Di.merge([Li.points, Li.fog]),
  ...
  depth: {
    uniforms: Di.merge([Li.common, Li.displacementmap]),
